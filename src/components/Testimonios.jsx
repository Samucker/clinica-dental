...
export default function Testimonios() {
  ...
  const [refStats, visibleStats] = useAnimacion()
  ...
  return (
    <section id="testimonios" className="py-24 bg-gray-50 overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        ...
        {/* Stats */}
        <div ref={refStats} className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20">
          {stats.map((s, i) => (
            <div
              key={i}
              style={{ transitionDelay: `${i * 100}ms` }}
              className={`bg-white rounded-2xl p-6 text-center shadow-sm border border-gray-100 transition-all duration-700 ${
        ...
        {/* Header */}
        <div ref={refHeader} className={`text-center mb-14 transition-all duration-700 ${
          ...
          {testimonios.map((t, i) => {
            ...
            return (
              <div
                ...
                className={`bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-all duration-500 flex flex-col gap-5 border border-gray-100 hover:-translate-y-1 ${
